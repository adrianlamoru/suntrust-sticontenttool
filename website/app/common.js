...
var ComponentType = {
    ...
    CLICK_TO_CHAT: 12,
    RIGHT_RAIL: 13,
    EMAIL_CALL_TO_ACTION: 14,
    EMAIL_HEADER_LINKS: 15,
    CC_MAIN_IMAGE:16
};
...
var ContentType = {
    ...
    HEADER_LINKS_CONTENT: 'HeaderLinksContent'
};
...
var EmailHeaderLinks = {
    FIRST_LINK: 'FirstLink',
    SECOND_LINK: 'SecondLink',
    THIRD_LINK: 'ThirdLink'
};

var EmailTags = {
    CASH_BACK_PERCENT: {ID: '[[81]]', Value: '5%'},
    CASH_BACK_MONTHS: { ID: '[[82]]', Value: '12' },
    OTHER_CASH_BACK_PERCENT: { ID: '[[83]]', Value: '2%' },
    INTRO_INTEREST: { ID: '[[84]]', Value: '3%' },
    INTRO_INTEREST_MONTHS: { ID: '[[85]]', Value: '18' },
    PROMO_EXPIRE_DATE: { ID: '[[86]]', Value: translateCurrentDate() },
    OFFER_AMOUNT: { ID: '[[87]]', Value: '$150' },
    APPLY_NOW: { ID: '[[CTA-APPLY-NOW]]', Value: 'htmlCode' }
};
...
function translateCurrentDate() {
    ...
    caculatedDate = months[mm] + " " + dd + ", " + yyyy;
