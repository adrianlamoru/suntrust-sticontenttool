appControllers.controller('EmailTemplateController', function ($scope, $rootScope, CommonService, projectManager) {

    console.log("EmailTemplateController - MOD");
    $scope.projectManager = projectManager;
   // alert("EmailTemplateController");
    ...
    //                //$scope.createOfferModel.OfferType = $scope.selectedOfferType.Name;
    //                $scope.createOfferModel.OfferType = $scope.selectedOfferType.Value;
    //                console.log("$scope.selectedOfferType.Value ", $scope.selectedOfferType.Value);
