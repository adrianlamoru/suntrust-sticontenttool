appServices.service('CommonService', function ($http) {
    ...
    this.getOffersByOfferType = function (offerTypeId, callbackSuccess, errorCallback) {
        $http.get(BASE_URL + '/api/Offer/OffersByType/' + offerTypeId)
            .success(function (data) {
                callbackSuccess(data);
            }).error(function (data, status) {
                errorCallback(data, status);
    ...
    this.getAvailableOffersByOfferType = function (offerTypeId, callbackSuccess, errorCallback) {
        $http.get(BASE_URL + '/api/Offer/AvailablesByOfferType/' + offerTypeId)
            .success(function (data) {
                callbackSuccess(data);
            }).error(function (data, status) {
                errorCallback();
    ...
    this.copyFromOffer = function (json, callbackSuccess, errorCallback) {
        $http.post(BASE_URL + '/api/Offer/Copy', json)
            .success(function (data) {
                callbackSuccess(data);
            })
            .error(function (data, status) {
