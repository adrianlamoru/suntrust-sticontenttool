...
.value('taOptions',  {
	toolbar: [
		...
		['justifyLeft', 'justifyCenter', 'justifyRight', 'indent', 'outdent', 'fontColor'],
...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', function(taRegisterTool, $window, taTranslations, taSelection){
	...
	taRegisterTool('insertLink', {
		...
		onElementSelect: {
			...
			action: function(event, $element, editorScope){
				...
				var targetToggle = angular.element('<button type="button" class="btn btn-default btn-sm btn-small" tabindex="-1" unselectable="on">Set to Open in New Window</button>');
	...
	taRegisterTool('sup', {
	    ...
	    activeState: function () {
	        var value = document.queryCommandState('superscript');
	        
	        //console.log("subscript queryCommandState: " + value);
	...
	taRegisterTool('fontColor', {
	    ...
	    activeState: function () {
	        var value = document.queryCommandState('foreColor');
	        return this.$editor().queryCommandState('foreColor', value);
	    }
    });
    ...
    taRegisterTool('fontSize', {
        ...
        activeState: function () {
            var value = document.queryCommandState('fontSize');
            return this.$editor().queryCommandState('fontSize', value);
        }
    });
}]);
