    ...
    function ($routeProvider) {
        $routeProvider.
          ...
          when('/equity/:projectID', {
            ...
            when('/email-template/:projectID', {
                templateUrl: BASE_URL + '/app/views/email-campaign/email-config.html',
                controller: 'SectionController'
            }).when('/rto-allOffers/:projectID', {
                templateUrl: BASE_URL + '/app/views/rto-allOffers.html',
                controller: 'SectionController'
            }).
          otherwise({
